...
- Remove WebKit redraw hack
  ...
  - This fix is no longer needed in modern WebKit Browsers and caused issues on Chrome on Android, see https://github.com/GitToTheHub/cordova-plugin-googlemaps/issues/19
...
- fix: browser cluster icon opacity: Eliminates the conflicting pull on iconMarker's opacity and establishes a clear path for opacity changes originating from self [PR #11](https://github.com/GitToTheHub/cordova-plugin-googlemaps/pull/11). Thanks to [leyenda](https://github.com/leyenda).
